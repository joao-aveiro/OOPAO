...
class Photometry:
    ...
    # Ref.: Campins et al (1985) (doi:10.1086/113799)
    # Legend: wl Wavelength, bw Bandwidth, zp Zero-Point at m=0, uzp Zero-Point uncertainty
    # Units: wv [m], bw [m], zp [Jy], uzp [Jy]
    J = {"wl": 1.26e-6, "bw": 0.20e-6, "zp": 1603, "uzp": 34}
    H = {"wl": 1.60e-6, "bw": 0.26e-6, "zp": 1075, "uzp": 32}
    K = {"wl": 2.22e-6, "bw": 0.52e-6, "zp": 667, "uzp": 14}
    L = {"wl": 3.54e-6, "bw": 0.97e-6, "zp": 288, "uzp": 6}
    M = {"wl": 4.80e-6, "bw": 0.60e-6, "zp": 170, "uzp": 8}
